			...
			if dock.get_class() == dclass or dock.name == dclass:
				dock.set_meta(
					...
					(
						...
						if tabcontainer.get_index() == 0
						else EditorPlugin.DOCK_SLOT_LEFT_BL
					)
				)
				return dock
			...
			if dock.get_class() == dclass or dock.name == dclass:
				dock.set_meta(
					...
					(
						...
						if tabcontainer.get_index() == 0
						else EditorPlugin.DOCK_SLOT_LEFT_BR
					)
				)
				return dock
			...
			if dock.get_class() == dclass or dock.name == dclass:
				dock.set_meta(
					...
					(
						...
						if tabcontainer.get_index() == 0
						else EditorPlugin.DOCK_SLOT_RIGHT_BL
					)
				)
				return dock
			...
			if dock.get_class() == dclass or dock.name == dclass:
				dock.set_meta(
					...
					(
						...
						if tabcontainer.get_index() == 0
						else EditorPlugin.DOCK_SLOT_RIGHT_BR
					)
				)
				return dock
